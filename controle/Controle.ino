...
const char* ssid = "SERVEIGOR";
const char* password = "igor2772";
const char* ID = "B68AB3FB";
const char* ID1 = "0B7F350C";
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
...
void loop() {
  ...
  mfrc522.PICC_HaltA();
    ...
    http.begin("http://10.0.0.112/controle/getUID.php");  //Specify request destination
...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------//
void sendRfid(String StrUID){
    if(StrUID == ID or StrUID == ID1){


      HTTPClient http;
      String postData = "cardid=" + String(StrUID) + "&action=insertRfIdLog";
      http.begin("http://10.0.0.112/controle/log.php");            
